...
@tipo_usuario_bp.route("/api/tipos-usuario", methods=["GET"])
...
@tipo_usuario_bp.route("/api/tipos-usuario/<int:id>", methods=["GET"])
...
@tipo_usuario_bp.route("/api/tipos-usuario", methods=["POST"])
...
@tipo_usuario_bp.route("/api/tipos-usuario/<int:id>", methods=["PUT"])
@auth_required
...
@tipo_usuario_bp.route("/api/tipos-usuario/<int:id>", methods=["DELETE"])
@auth_required
