"""adiciona data_criacao e data_atualizacao em usuario

Revision ID: 779d3a03910a
Revises: 4c6e2e8bd88e
Create Date: 2025-05-31 14:20:12.836294
...
revision: str = '779d3a03910a'
down_revision: Union[str, None] = '4c6e2e8bd88e'
...
def upgrade() -> None:
    ...
    op.drop_table('trabalhe_conosco')
...
def downgrade() -> None:
    ...
    sa.Column('data_criacao', mysql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.Column('data_atualizacao', mysql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['id_usuario'], ['usuario.id'], name='servico_ibfk_1', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    ...
    sa.Column('data_criacao', mysql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.Column('data_atualizacao', mysql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['id_cliente'], ['cliente.id'], name=op.f('fazenda_ibfk_1'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['id_endereco'], ['endereco.id'], name=op.f('fazenda_ibfk_2'), ondelete='SET NULL'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    ...
    sa.Column('data_criacao', mysql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.Column('data_atualizacao', mysql.TIMESTAMP(), nullable=True),
    sa.ForeignKeyConstraint(['id_endereco'], ['endereco.id'], name=op.f('loja_ibfk_2'), ondelete='SET NULL'),
    sa.ForeignKeyConstraint(['id_usuario'], ['usuario.id'], name=op.f('loja_ibfk_1'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    ...
    sa.Column('data_avaliacao', mysql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.ForeignKeyConstraint(['id_cliente'], ['cliente.id'], name=op.f('avaliacao_ibfk_2'), ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['id_servico'], ['servico.id'], name=op.f('avaliacao_ibfk_1'), ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
    mysql_engine='InnoDB'
    )
    op.create_table('trabalhe_conosco',
    sa.Column('id', mysql.INTEGER(), autoincrement=True, nullable=False),
    sa.Column('nome', mysql.VARCHAR(length=100), nullable=False),
    sa.Column('email', mysql.VARCHAR(length=100), nullable=False),
    sa.Column('telefone', mysql.VARCHAR(length=20), nullable=True),
    sa.Column('mensagem', mysql.TEXT(), nullable=False),
    sa.Column('curriculo_link', mysql.VARCHAR(length=255), nullable=True),
    sa.Column('data_envio', mysql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), nullable=True),
    sa.PrimaryKeyConstraint('id'),
    mysql_collate='utf8mb4_0900_ai_ci',
    mysql_default_charset='utf8mb4',
